...
export default {
    ...
    methods:{
      ...
      deleteTodo(_,id){   //用下划线_占个位，否则第一个参数传入的是事件名
    ...
    mounted() {
      ...
      this.$bus.$on('clearChecked',this.clearChecked)
      this.pubId = pubsub.subscribe('deleteTodo',this.deleteTodo)  //当deleteTodo发布时，调用deleteTodo回调函数
